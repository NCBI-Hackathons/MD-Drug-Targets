data = load('structureTrack/data_pocket_track.mat');
...
%saveResults
saveResults.dir = '/project/hackathon/hackers04/shared/tracks/'; %directory where to save input and output
saveResults.filename = 'utrack-nomerge-output.mat'; %name of file where input and output are saved
...
[tracksFinal,kalmanInfoLink,errFlag] = trackCloseGapsKalmanSparse(data.datapocket,...
